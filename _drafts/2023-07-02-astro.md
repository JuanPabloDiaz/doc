...
- Inicializar Astro usando una versión particular:
  ...
  ```bash
  npm create astro@2.0.2 nombre-nuevo-projecto
  ```

- Or, inicializar Astro usando la última versión?

  ```bash
  npm create astro@latest nombre-nuevo-projecto
  ```
...
1. Despues de correr el codigo, siga los promps para terminar la iniciacion.
2. Ingrese al nuevo proyecto `cd theme-name`.
3. Corra el proyecto en local:
   ```bash
   npm run dev
   ```
4. Abra el navegador en `http://localhost:3000/` para visualizar el proyecto.
